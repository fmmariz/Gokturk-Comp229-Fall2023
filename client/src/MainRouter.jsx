...
<>
    ...
    <Switch>
      ...
      <ReroutingRoutes currentStatus={props.currentStatus} changeLogStatus={props.changeLogStatus} exact path='/listproducts' accessibleIfLoggedIn={false} pathToReroute={'/signin'} component={ProductList} />
